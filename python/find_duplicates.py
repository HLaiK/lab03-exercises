...
print("\nSolving with a Dictionary/Map")

def find_duplicates_dictionary_map(l: list) -> list:
    counts = {}
    duplicates = []
...
if __name__ == "__main__":
    ...
    print("Sample 1:", find_duplicates_dictionary_map(sample1))
    print("Sample 2:", find_duplicates_dictionary_map(sample2))
    print("Sample 3:", find_duplicates_dictionary_map(sample3))
    print("Sample 4:", find_duplicates_dictionary_map(sample4))